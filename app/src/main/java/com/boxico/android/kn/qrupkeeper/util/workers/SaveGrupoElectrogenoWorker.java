...
public class SaveGrupoElectrogenoWorker extends Worker {
    final WorkerParameters myWorkerParams;

    public SaveGrupoElectrogenoWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        ...
        if(t.getIdRemoteDB() != 0 && t.getIdRemoteDB() != -1){// ES UN FORMULARIO EXISTENTE
            ...
            try {
                callInsert = ConstantsAdmin.tableroService.saveGrupoElectrogeno(t.getName(), t.getCode(), t.getDescription(), t.getPercent_comb(), t.getTemperatura(), t.getAuto(), t.getPrecalent(), t.getCargadorbat(), t.getAlarma(), t.getIdForm(), ConstantsAdmin.tokenIplan);                resp = callInsert.execute();
                if(resp != null){
