...
public class SavePresurizacionCanieriaWorker extends Worker {
    final WorkerParameters myWorkerParams;

    public SavePresurizacionCanieriaWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
