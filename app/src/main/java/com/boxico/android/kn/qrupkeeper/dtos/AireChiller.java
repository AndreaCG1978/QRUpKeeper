...
public class AireChiller extends AbstractArtefactDto {
    ...
    @SerializedName("pprim")
    @Expose
    private String pprim;
    ...
    public void setPprim(String pprim) {
        this.pprim = pprim;
    }
    ...
    public AireChiller(int id, String name, int codigo, int idForm, int idRemoteDB, String comp1_ok, String comp2_ok, String comp1_load, String comp2_load, String out, String desc, String pprim, String psec) {
    ...
    public String toString() {
        ...
        if(name != null && !name.equals("")){
            temp = "░ CHILLER[" + name + "]:" + ConstantsAdmin.ENTER;
        }else{
            temp = "░ CHILLER:" + ConstantsAdmin.ENTER;
        }
