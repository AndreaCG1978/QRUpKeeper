...
public class TableroTGBT  extends AbstractArtefactDto {
    ...
    public TableroTGBT(int id, String name, String kwr, String kws, String kwt, String par, String pas, String pat, int codigo, int idForm, int idRemoteDB, String desc) {
