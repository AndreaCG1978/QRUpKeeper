...
public class SavePresurizacionEscaleraWorker extends Worker {
    final WorkerParameters myWorkerParams;

    public SavePresurizacionEscaleraWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
